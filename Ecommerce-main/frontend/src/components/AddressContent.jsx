...
// className="flex items-center gap-2 border border-zinc-800 p-4 mb-6 hover:bg-[#1A1A1A]"
// >
// <Plus size={18}/>
// Add New Address
// </button>
...
// <div className="border border-zinc-800 p-6 mb-8 bg-[#1A1A1A]">

// <input
// placeholder="Name"
// className="w-full p-3 mb-3 bg-[#0A0A0A] border border-zinc-800"
// value={formData.name}
...
// className="w-full p-3 mb-4 bg-[#0A0A0A] border border-zinc-800"
...
// className="bg-[#C8A253] text-black px-8 py-2"
// >
// {editId ? "Update" : "Save"}
// </button>
...
// <div
// key={item.id}
// className="border border-zinc-800 p-5 bg-[#1A1A1A]"
// >
