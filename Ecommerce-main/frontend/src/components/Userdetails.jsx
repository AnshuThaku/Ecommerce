...
//     <div className="p-8 bg-[#111111] h-full text-white">

//       {/* HEADER */}
//       <div className="flex items-center justify-between mb-6 border-b border-zinc-800 pb-4">
//         <h2 className="text-2xl font-serif text-[#C8A253]">
...
//               className="text-green-500 font-bold text-sm uppercase flex items-center gap-1"
//             >
//               <Check size={16} /> Save
//             </button>
...
//               className="text-red-500 font-bold text-sm uppercase flex items-center gap-1"
//             >
//               <X size={16} /> Cancel
//             </button>
...
//             ${
//               isEditingProfile
//                 ? "bg-[#1A1A1A] border-[#C8A253]"
//                 : "bg-transparent border-zinc-800 text-gray-400"
//             }`}
//           />
...
//         <h2 className="text-xl font-serif text-[#C8A253] mb-4">
//           Email Address
//         </h2>
...
//       <button className="text-red-500 font-bold text-sm uppercase">
//         Delete Account
//       </button>
