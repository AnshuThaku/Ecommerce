...
// // Assuming axiosInstance and useAuth are available in your context/utils
...
//   return (
//     <div className={`fixed inset-0 z-[100] flex transition-all duration-500 ease-in-out ${expand ? 'items-start bg-white p-0' : 'items-center justify-center bg-black/70 backdrop-blur-sm p-4 md:p-6'}`} onClick={onClose}>
...
//             {/* Same expanded details as original */}
