...
export default function ProductSlide() {
  ...
  const handleCategoryClick = (categoryName) => {
    // Ye user ko Shop page par bhejega aur URL mein category ka naam daal dega
    // Example: /shop?category=Bluetooth%20Speaker
        ...
        >
          {loading ? (
            ...
            categories.map((item) => (
              <div 
                key={item.id} 
                onClick={() => handleCategoryClick(item.name)} // 👈 YAHAN CHANGE KIYA HAI
