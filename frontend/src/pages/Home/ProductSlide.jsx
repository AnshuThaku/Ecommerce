...
export default function ProductSlide() {
  ...
  return (
    <div className="bg-white py-12 w-full border-y border-gray-100">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 mb-8 flex justify-center">
        <h2 className="text-2xl md:text-3xl font-serif italic text-black flex items-center justify-center gap-3">
          Shop By <span className="text-[#d3b574]">Category</span>
        </h2>
      </div>
